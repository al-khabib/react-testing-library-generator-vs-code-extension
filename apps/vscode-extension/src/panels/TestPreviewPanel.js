...
exports.TestPreviewPanel = void 0;
const vscode = __importStar(require("vscode"));
class TestPreviewPanel {
    constructor(context) {
        this.context = context;
        this.disposables = [];
        this.panel = vscode.window.createWebviewPanel("rtlTestPreview", "🧪 RTL Test Preview", vscode.ViewColumn.Two, {
            enableScripts: true,
            localResourceRoots: [
    ...
    updateTestCode(testCode, componentName) {
    ...
    async saveTestToFile(testCode, filePath) {
        try {
    ...
    async regenerateTest(style) {
        vscode.window.showInformationMessage(`🔄 Regenerating test with ${style} style...`);
...
exports.TestPreviewPanel = TestPreviewPanel;
//# sourceMappingURL=TestPreviewPanel.js.map